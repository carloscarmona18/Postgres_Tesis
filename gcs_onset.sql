...
DROP TABLE IF EXISTS gcs_hora1 CASCADE;
create table gcs_hora1 as
with base as
(
  ...
  inner join cohorte_4 cor
    on l.icustay_id = cor.icustay_id
  ...
  -- Only get data for the first 24 hour
	  
  and l.charttime between (cor.onset - interval '12' hour ) and ( cor.onset - interval '1' hour)
